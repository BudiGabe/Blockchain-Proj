...
contract MusicNFTMarketplace is ERC721("MusicFi", "MFI"), Ownable {
    string public baseURI = "https://bafybeiggxjofjq3yrims4loljshy5ve32lhxek7hljxp3eqsrszswa2pbu.ipfs.nftstorage.link/";
    string public baseExtension = ".json";
    address public artist;
    uint256 public royaltyFee;

    // Structure of each music NFT
    struct MarketItem {
        uint256 tokenId;
    ...
    // The deployer is actually the first seller => constructor is payable
    // to pay the initial royalty fee
    constructor(
        uint256 _royaltyFee,
        address _artist,
    ...
    // Update royalty fee of the contract only if the deployer calls for this
    ...
    function buyToken(uint256 _tokenId) external payable {
        ...
        // NFT has been purchased, no one is selling it anymore
