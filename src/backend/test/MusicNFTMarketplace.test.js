...
describe("MusicNFTMarketplace", function () {
    ...
    let URI = "https://bafybeiggxjofjq3yrims4loljshy5ve32lhxek7hljxp3eqsrszswa2pbu.ipfs.nftstorage.link/"
    ...
    describe("Buying tokens", function () {
        ...
        describe("Reselling tokens", function () {
          ...
          it("Should track resale item, increase ether balance by royalty fee, transfer NFT to marketplace and emit MarketItemRelisted event", async function () {
      ...
      describe("Getter functions", function () {
        ...
        it("getAllUnsoldTokens should fetch all the marketplace items up for sale", async function () {
          ...
          expect(unsoldItems.every(i => !soldItems.some(j => j === i.tokenId.toNumber()))).to.equal(true)          // Check that the length is correct
